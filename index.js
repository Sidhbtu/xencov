...
//make order_id as primary key
            pool.query("INSERT INTO 5m_Sales_Records(Order_ID, Region, Country, Item_Type, Sales_Channel, Order_Priority, Order_Date,Ship_Date,Units_Sold,Unit_Price,Unit_Cost,Total_Revenue,Total_Cost,Total_Profit) \
